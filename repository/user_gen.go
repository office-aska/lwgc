...
//go:generate mockgen -source $GOFILE -destination mock/mock_user_gen/mock_user_gen.go
...
func NewUserRepository(firestoreClient *firestore.Client, middleware ...UserRepositoryMiddleware) UserRepository {
	return &userRepository{
		...
		uniqueRepository: newUniqueRepository(firestoreClient, "User"),
	}
}

func (repo *userRepository) setMeta(subject *model.User, isInsert bool) {
	now := time.Now()
...
func (repo *userRepository) setMetaWithStrictUpdate(param *UserUpdateParam) {
	param.UpdatedAt = firestore.ServerTimestamp
	param.Version = firestore.Increment(1)
}

func (repo *userRepository) beforeInsert(ctx context.Context, subject *model.User) (RollbackFunc, error) {
...
func (repo *userRepository) beforeUpdate(ctx context.Context, old, subject *model.User) (RollbackFunc, error) {
...
func (repo *userRepository) beforeDelete(ctx context.Context, subject *model.User, opts ...DeleteOption) (RollbackFunc, error) {
	repo.setMeta(subject, false)
	repo.uniqueRepository.setMiddleware(ctx)
...
func (repo *userRepository) GetCollection() *firestore.CollectionRef {
	return repo.firestoreClient.Collection(repo.collectionName)
}

// GetCollectionName - CollectionName getter
func (repo *userRepository) GetCollectionName() string {
	return repo.collectionName
}

// GetDocRef - *firestore.DocumentRef getter
func (repo *userRepository) GetDocRef(id string) *firestore.DocumentRef {
	return repo.GetCollection().Doc(id)
}

// RunInTransaction - (*firestore.Client).RunTransaction getter
func (repo *userRepository) RunInTransaction() func(ctx context.Context, f func(context.Context, *firestore.Transaction) error, opts ...firestore.TransactionOption) (err error) {
...
func (repo *userRepository) Search(ctx context.Context, param *UserSearchParam, q *firestore.Query) ([]*model.User, error) {
	return repo.search(ctx, param, q)
}

// Get - get `User` by `User.ID`
func (repo *userRepository) Get(ctx context.Context, id string, opts ...GetOption) (*model.User, error) {
	doc := repo.GetDocRef(id)
	return repo.get(ctx, doc, opts...)
}

// GetWithDoc - get `User` by *firestore.DocumentRef
func (repo *userRepository) GetWithDoc(ctx context.Context, doc *firestore.DocumentRef, opts ...GetOption) (*model.User, error) {
	return repo.get(ctx, doc, opts...)
}

// Insert - insert of `User`
func (repo *userRepository) Insert(ctx context.Context, subject *model.User) (_ string, err error) {
...
// Update - update of `User`
func (repo *userRepository) Update(ctx context.Context, subject *model.User) (err error) {
	doc := repo.GetDocRef(subject.ID)
...
// StrictUpdate - strict update of `User`
func (repo *userRepository) StrictUpdate(ctx context.Context, id string, param *UserUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(ctx, id, param, opts...)
}

// Delete - delete of `User`
func (repo *userRepository) Delete(ctx context.Context, subject *model.User, opts ...DeleteOption) (err error) {
...
func (repo *userRepository) DeleteByID(ctx context.Context, id string, opts ...DeleteOption) (err error) {
...
// GetMulti - get `User` in bulk by array of `User.ID`
func (repo *userRepository) GetMulti(ctx context.Context, ids []string, opts ...GetOption) ([]*model.User, error) {
	return repo.getMulti(ctx, ids, opts...)
}

// InsertMulti - bulk insert of `User`
func (repo *userRepository) InsertMulti(ctx context.Context, subjects []*model.User) (_ []string, er error) {
...
// UpdateMulti - bulk update of `User`
func (repo *userRepository) UpdateMulti(ctx context.Context, subjects []*model.User) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
// DeleteMulti - bulk delete of `User`
func (repo *userRepository) DeleteMulti(ctx context.Context, subjects []*model.User, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
// DeleteMultiByIDs - delete `User` in bulk by array of `User.ID`
func (repo *userRepository) DeleteMultiByIDs(ctx context.Context, ids []string, opts ...DeleteOption) (er error) {
	subjects := make([]*model.User, len(ids))
...
func (repo *userRepository) SearchWithTx(tx *firestore.Transaction, param *UserSearchParam, q *firestore.Query) ([]*model.User, error) {
	return repo.search(tx, param, q)
}

// GetWithTx - get `User` by `User.ID` in transaction
func (repo *userRepository) GetWithTx(tx *firestore.Transaction, id string, opts ...GetOption) (*model.User, error) {
	doc := repo.GetDocRef(id)
	return repo.get(tx, doc, opts...)
}

// GetWithDocWithTx - get `User` by *firestore.DocumentRef in transaction
func (repo *userRepository) GetWithDocWithTx(tx *firestore.Transaction, doc *firestore.DocumentRef, opts ...GetOption) (*model.User, error) {
	return repo.get(tx, doc, opts...)
}

// InsertWithTx - insert of `User` in transaction
func (repo *userRepository) InsertWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.User) (_ string, err error) {
...
// UpdateWithTx - update of `User` in transaction
func (repo *userRepository) UpdateWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.User) (err error) {
...
// StrictUpdateWithTx - strict update of `User` in transaction
func (repo *userRepository) StrictUpdateWithTx(tx *firestore.Transaction, id string, param *UserUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(tx, id, param, opts...)
}

// DeleteWithTx - delete of `User` in transaction
func (repo *userRepository) DeleteWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.User, opts ...DeleteOption) (err error) {
	if len(opts) > 0 && opts[0].Mode == DeleteModeSoft {
		t := time.Now()
		subject.DeletedAt = &t
...
// DeleteByIDWithTx - delete `User` by `User.ID` in transaction
func (repo *userRepository) DeleteByIDWithTx(ctx context.Context, tx *firestore.Transaction, id string, opts ...DeleteOption) (err error) {
...
// GetMultiWithTx - get `User` in bulk by array of `User.ID` in transaction
func (repo *userRepository) GetMultiWithTx(tx *firestore.Transaction, ids []string, opts ...GetOption) ([]*model.User, error) {
	return repo.getMulti(tx, ids, opts...)
}

// InsertMultiWithTx - bulk insert of `User` in transaction
func (repo *userRepository) InsertMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.User) (_ []string, er error) {
...
// UpdateMultiWithTx - bulk update of `User` in transaction
func (repo *userRepository) UpdateMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.User) (er error) {
	ctx = context.WithValue(ctx, transactionInProgressKey{}, 1)
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
...
// DeleteMultiWithTx - bulk delete of `User` in transaction
func (repo *userRepository) DeleteMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.User, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
// DeleteMultiByIDWithTx - delete `User` in bulk by array of `User.ID` in transaction
func (repo *userRepository) DeleteMultiByIDsWithTx(ctx context.Context, tx *firestore.Transaction, ids []string, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
func (repo *userRepository) get(v interface{}, doc *firestore.DocumentRef, opts ...GetOption) (*model.User, error) {
	var (
...
func (repo *userRepository) getMulti(v interface{}, ids []string, opts ...GetOption) ([]*model.User, error) {
	var (
	...
	subjects := make([]*model.User, 0, len(ids))
	mErr := NewMultiErrors()
...
func (repo *userRepository) insert(v interface{}, subject *model.User) (string, error) {
	var (
...
func (repo *userRepository) update(v interface{}, subject *model.User) error {
	var (
...
func (repo *userRepository) strictUpdate(v interface{}, id string, param *UserUpdateParam, opts ...firestore.Precondition) error {
	var (
	...
	updates := updater(model.User{}, param)
...
func (repo *userRepository) deleteByID(v interface{}, id string) error {
	dr := repo.GetDocRef(id)
	var err error
...
func (repo *userRepository) runQuery(v interface{}, query firestore.Query) ([]*model.User, error) {
...
var userRepositoryMeta = tagMap(model.User{})

// BUG(54m): there may be potential bugs
func (repo *userRepository) search(v interface{}, param *UserSearchParam, q *firestore.Query) ([]*model.User, error) {
