...
//go:generate mockgen -source $GOFILE -destination mock/mock_organization_gen/mock_organization_gen.go
...
type organizationRepository struct {
	...
	middleware       []OrganizationRepositoryMiddleware
...
func NewOrganizationRepository(firestoreClient *firestore.Client, middleware ...OrganizationRepositoryMiddleware) OrganizationRepository {
	return &organizationRepository{
		...
		uniqueRepository: newUniqueRepository(firestoreClient, "Organization"),
	}
}

func (repo *organizationRepository) setMeta(subject *model.Organization, isInsert bool) {
	now := time.Now()
...
func (repo *organizationRepository) setMetaWithStrictUpdate(param *OrganizationUpdateParam) {
	param.UpdatedAt = firestore.ServerTimestamp
	param.Version = firestore.Increment(1)
}

func (repo *organizationRepository) beforeInsert(ctx context.Context, subject *model.Organization) (RollbackFunc, error) {
...
func (repo *organizationRepository) beforeUpdate(ctx context.Context, old, subject *model.Organization) (RollbackFunc, error) {
...
func (repo *organizationRepository) beforeDelete(ctx context.Context, subject *model.Organization, opts ...DeleteOption) (RollbackFunc, error) {
	repo.setMeta(subject, false)
	repo.uniqueRepository.setMiddleware(ctx)
...
func (repo *organizationRepository) GetCollection() *firestore.CollectionRef {
	return repo.firestoreClient.Collection(repo.collectionName)
}

// GetCollectionName - CollectionName getter
func (repo *organizationRepository) GetCollectionName() string {
	return repo.collectionName
}

// GetDocRef - *firestore.DocumentRef getter
func (repo *organizationRepository) GetDocRef(id string) *firestore.DocumentRef {
	return repo.GetCollection().Doc(id)
}

// RunInTransaction - (*firestore.Client).RunTransaction getter
func (repo *organizationRepository) RunInTransaction() func(ctx context.Context, f func(context.Context, *firestore.Transaction) error, opts ...firestore.TransactionOption) (err error) {
...
func (repo *organizationRepository) Search(ctx context.Context, param *OrganizationSearchParam, q *firestore.Query) ([]*model.Organization, error) {
	return repo.search(ctx, param, q)
}

// Get - get `Organization` by `Organization.ID`
func (repo *organizationRepository) Get(ctx context.Context, id string, opts ...GetOption) (*model.Organization, error) {
	doc := repo.GetDocRef(id)
	return repo.get(ctx, doc, opts...)
}

// GetWithDoc - get `Organization` by *firestore.DocumentRef
func (repo *organizationRepository) GetWithDoc(ctx context.Context, doc *firestore.DocumentRef, opts ...GetOption) (*model.Organization, error) {
	return repo.get(ctx, doc, opts...)
}

// Insert - insert of `Organization`
func (repo *organizationRepository) Insert(ctx context.Context, subject *model.Organization) (_ string, err error) {
...
// Update - update of `Organization`
func (repo *organizationRepository) Update(ctx context.Context, subject *model.Organization) (err error) {
	doc := repo.GetDocRef(subject.ID)
...
// StrictUpdate - strict update of `Organization`
func (repo *organizationRepository) StrictUpdate(ctx context.Context, id string, param *OrganizationUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(ctx, id, param, opts...)
}

// Delete - delete of `Organization`
func (repo *organizationRepository) Delete(ctx context.Context, subject *model.Organization, opts ...DeleteOption) (err error) {
...
// DeleteByID - delete `Organization` by `Organization.ID`
func (repo *organizationRepository) DeleteByID(ctx context.Context, id string, opts ...DeleteOption) (err error) {
...
// GetMulti - get `Organization` in bulk by array of `Organization.ID`
func (repo *organizationRepository) GetMulti(ctx context.Context, ids []string, opts ...GetOption) ([]*model.Organization, error) {
	return repo.getMulti(ctx, ids, opts...)
}

// InsertMulti - bulk insert of `Organization`
func (repo *organizationRepository) InsertMulti(ctx context.Context, subjects []*model.Organization) (_ []string, er error) {
...
// UpdateMulti - bulk update of `Organization`
func (repo *organizationRepository) UpdateMulti(ctx context.Context, subjects []*model.Organization) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
// DeleteMulti - bulk delete of `Organization`
func (repo *organizationRepository) DeleteMulti(ctx context.Context, subjects []*model.Organization, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
// DeleteMultiByIDs - delete `Organization` in bulk by array of `Organization.ID`
func (repo *organizationRepository) DeleteMultiByIDs(ctx context.Context, ids []string, opts ...DeleteOption) (er error) {
	subjects := make([]*model.Organization, len(ids))
...
func (repo *organizationRepository) SearchWithTx(tx *firestore.Transaction, param *OrganizationSearchParam, q *firestore.Query) ([]*model.Organization, error) {
	return repo.search(tx, param, q)
}

// GetWithTx - get `Organization` by `Organization.ID` in transaction
func (repo *organizationRepository) GetWithTx(tx *firestore.Transaction, id string, opts ...GetOption) (*model.Organization, error) {
	doc := repo.GetDocRef(id)
	return repo.get(tx, doc, opts...)
}

// GetWithDocWithTx - get `Organization` by *firestore.DocumentRef in transaction
func (repo *organizationRepository) GetWithDocWithTx(tx *firestore.Transaction, doc *firestore.DocumentRef, opts ...GetOption) (*model.Organization, error) {
	return repo.get(tx, doc, opts...)
}

// InsertWithTx - insert of `Organization` in transaction
func (repo *organizationRepository) InsertWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Organization) (_ string, err error) {
...
// UpdateWithTx - update of `Organization` in transaction
func (repo *organizationRepository) UpdateWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Organization) (err error) {
...
// StrictUpdateWithTx - strict update of `Organization` in transaction
func (repo *organizationRepository) StrictUpdateWithTx(tx *firestore.Transaction, id string, param *OrganizationUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(tx, id, param, opts...)
}

// DeleteWithTx - delete of `Organization` in transaction
func (repo *organizationRepository) DeleteWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Organization, opts ...DeleteOption) (err error) {
	if len(opts) > 0 && opts[0].Mode == DeleteModeSoft {
		t := time.Now()
		subject.DeletedAt = &t
...
// DeleteByIDWithTx - delete `Organization` by `Organization.ID` in transaction
func (repo *organizationRepository) DeleteByIDWithTx(ctx context.Context, tx *firestore.Transaction, id string, opts ...DeleteOption) (err error) {
...
// GetMultiWithTx - get `Organization` in bulk by array of `Organization.ID` in transaction
func (repo *organizationRepository) GetMultiWithTx(tx *firestore.Transaction, ids []string, opts ...GetOption) ([]*model.Organization, error) {
	return repo.getMulti(tx, ids, opts...)
}

// InsertMultiWithTx - bulk insert of `Organization` in transaction
func (repo *organizationRepository) InsertMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Organization) (_ []string, er error) {
...
// UpdateMultiWithTx - bulk update of `Organization` in transaction
func (repo *organizationRepository) UpdateMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Organization) (er error) {
	ctx = context.WithValue(ctx, transactionInProgressKey{}, 1)
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
...
// DeleteMultiWithTx - bulk delete of `Organization` in transaction
func (repo *organizationRepository) DeleteMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Organization, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
// DeleteMultiByIDWithTx - delete `Organization` in bulk by array of `Organization.ID` in transaction
func (repo *organizationRepository) DeleteMultiByIDsWithTx(ctx context.Context, tx *firestore.Transaction, ids []string, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
func (repo *organizationRepository) get(v interface{}, doc *firestore.DocumentRef, opts ...GetOption) (*model.Organization, error) {
	var (
	...
	subject := new(model.Organization)
...
func (repo *organizationRepository) getMulti(v interface{}, ids []string, opts ...GetOption) ([]*model.Organization, error) {
	var (
	...
	subjects := make([]*model.Organization, 0, len(ids))
	mErr := NewMultiErrors()
...
func (repo *organizationRepository) insert(v interface{}, subject *model.Organization) (string, error) {
	var (
...
func (repo *organizationRepository) update(v interface{}, subject *model.Organization) error {
	var (
...
func (repo *organizationRepository) strictUpdate(v interface{}, id string, param *OrganizationUpdateParam, opts ...firestore.Precondition) error {
	var (
	...
	updates := updater(model.Organization{}, param)
...
func (repo *organizationRepository) deleteByID(v interface{}, id string) error {
	dr := repo.GetDocRef(id)
	var err error
...
func (repo *organizationRepository) runQuery(v interface{}, query firestore.Query) ([]*model.Organization, error) {
	...
	subjects := make([]*model.Organization, 0)
...
var organizationRepositoryMeta = tagMap(model.Organization{})

// BUG(54m): there may be potential bugs
func (repo *organizationRepository) search(v interface{}, param *OrganizationSearchParam, q *firestore.Query) ([]*model.Organization, error) {
	...
	if q == nil {
		if param.Name != nil {
			for _, chain := range param.Name.QueryGroup {
				query = query.Where("Name", chain.Operator, chain.Value)
			}
			if direction := param.Name.OrderByDirection; direction > 0 {
				query = query.OrderBy("Name", direction)
				query = param.Name.BuildCursorQuery(query)
			}
		}
		if param.LINEWorksAppID != nil {
			for _, chain := range param.LINEWorksAppID.QueryGroup {
				query = query.Where("LINEWorksAppID", chain.Operator, chain.Value)
			}
			if direction := param.LINEWorksAppID.OrderByDirection; direction > 0 {
				query = query.OrderBy("LINEWorksAppID", direction)
				query = param.LINEWorksAppID.BuildCursorQuery(query)
			}
		}
		if param.LINEWorksConsumerKey != nil {
			for _, chain := range param.LINEWorksConsumerKey.QueryGroup {
				query = query.Where("LINEWorksConsumerKey", chain.Operator, chain.Value)
			}
			if direction := param.LINEWorksConsumerKey.OrderByDirection; direction > 0 {
				query = query.OrderBy("LINEWorksConsumerKey", direction)
				query = param.LINEWorksConsumerKey.BuildCursorQuery(query)
			}
		}
		if param.LINEWorksDomain != nil {
			for _, chain := range param.LINEWorksDomain.QueryGroup {
				query = query.Where("LINEWorksDomain", chain.Operator, chain.Value)
			}
			if direction := param.LINEWorksDomain.OrderByDirection; direction > 0 {
				query = query.OrderBy("LINEWorksDomain", direction)
				query = param.LINEWorksDomain.BuildCursorQuery(query)
			}
		}
		if param.CreatedAt != nil {
			for _, chain := range param.CreatedAt.QueryGroup {
				query = query.Where(organizationRepositoryMeta["CreatedAt"], chain.Operator, chain.Value)
			}
			if direction := param.CreatedAt.OrderByDirection; direction > 0 {
				query = query.OrderBy(organizationRepositoryMeta["CreatedAt"], direction)
				query = param.CreatedAt.BuildCursorQuery(query)
			}
		}
		if param.CreatedBy != nil {
			for _, chain := range param.CreatedBy.QueryGroup {
				query = query.Where(organizationRepositoryMeta["CreatedBy"], chain.Operator, chain.Value)
			}
			if direction := param.CreatedBy.OrderByDirection; direction > 0 {
				query = query.OrderBy(organizationRepositoryMeta["CreatedBy"], direction)
				query = param.CreatedBy.BuildCursorQuery(query)
			}
		}
		if param.DeletedAt != nil {
			for _, chain := range param.DeletedAt.QueryGroup {
				query = query.Where(organizationRepositoryMeta["DeletedAt"], chain.Operator, chain.Value)
			}
			if direction := param.DeletedAt.OrderByDirection; direction > 0 {
				query = query.OrderBy(organizationRepositoryMeta["DeletedAt"], direction)
				query = param.DeletedAt.BuildCursorQuery(query)
			}
		}
		if param.DeletedBy != nil {
			for _, chain := range param.DeletedBy.QueryGroup {
				query = query.Where(organizationRepositoryMeta["DeletedBy"], chain.Operator, chain.Value)
			}
			if direction := param.DeletedBy.OrderByDirection; direction > 0 {
				query = query.OrderBy(organizationRepositoryMeta["DeletedBy"], direction)
				query = param.DeletedBy.BuildCursorQuery(query)
			}
		}
		if param.UpdatedAt != nil {
			for _, chain := range param.UpdatedAt.QueryGroup {
				query = query.Where(organizationRepositoryMeta["UpdatedAt"], chain.Operator, chain.Value)
			}
			if direction := param.UpdatedAt.OrderByDirection; direction > 0 {
				query = query.OrderBy(organizationRepositoryMeta["UpdatedAt"], direction)
				query = param.UpdatedAt.BuildCursorQuery(query)
			}
		}
		if param.UpdatedBy != nil {
			for _, chain := range param.UpdatedBy.QueryGroup {
				query = query.Where(organizationRepositoryMeta["UpdatedBy"], chain.Operator, chain.Value)
			}
			if direction := param.UpdatedBy.OrderByDirection; direction > 0 {
				query = query.OrderBy(organizationRepositoryMeta["UpdatedBy"], direction)
				query = param.UpdatedBy.BuildCursorQuery(query)
			}
		}
		if param.Version != nil {
			for _, chain := range param.Version.QueryGroup {
				query = query.Where(organizationRepositoryMeta["Version"], chain.Operator, chain.Value)
			}
			if direction := param.Version.OrderByDirection; direction > 0 {
				query = query.OrderBy(organizationRepositoryMeta["Version"], direction)
